...
import {
  selectStringInputCustomStyles,
  selectNumberInputCustomStyles,
} from '../../../../libs/reactSelectStyles';
import type { Option } from '../../../../ts/types/main/Option';
import { SlideshowType } from '../../../../ts/types/main/Slideshow';
import { EditSlideshowFormValues } from '../../../../ts/types/schema/SlideshowSchema';
import { editSlideshowSchema } from '../../../../utils/schema/slideshowSchema';
...
const SlideToModal = ({
  ...
  const {
    ...
    control,
    formState: { errors },
  } = useForm<EditSlideshowFormValues>({
    resolver: yupResolver(editSlideshowSchema),
  });
    ...
    },
    {
      onSuccess: async (response) => {
        if (response.status === 200) {
          setShowToast(true);
          setToastMessage('Slideshow berhasil diedit');
